...
namespace WebApplication
{
    ...
    public partial class AdventureWorks2022Entities : DbContext
    {
        ...
        [DbFunction("AdventureWorks2022Entities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2022Entities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "F_Num")]
        public virtual IQueryable<F_Num_Result> F_Num(Nullable<int> n)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<F_Num_Result>("[AdventureWorks2022Entities].[F_Num](@N)", nParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "Private_Bin2Hex")]
        public virtual IQueryable<Private_Bin2Hex_Result> Private_Bin2Hex(byte[] vb)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Private_Bin2Hex_Result>("[AdventureWorks2022Entities].[Private_Bin2Hex](@vb)", vbParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "Private_GetExternalAccessKeyBytes")]
        public virtual IQueryable<Private_GetExternalAccessKeyBytes_Result> Private_GetExternalAccessKeyBytes()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Private_GetExternalAccessKeyBytes_Result>("[AdventureWorks2022Entities].[Private_GetExternalAccessKeyBytes]()");
        }
    
        [DbFunction("AdventureWorks2022Entities", "Private_GetFullTypeName")]
        public virtual IQueryable<Private_GetFullTypeName_Result> Private_GetFullTypeName(Nullable<int> typeId, Nullable<int> length, Nullable<int> precision, Nullable<int> scale, string collationName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Private_GetFullTypeName_Result>("[AdventureWorks2022Entities].[Private_GetFullTypeName](@TypeId, @Length, @Precision, @Scale, @CollationName)", typeIdParameter, lengthParameter, precisionParameter, scaleParameter, collationNameParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "Private_GetOriginalTableInfo")]
        public virtual IQueryable<Private_GetOriginalTableInfo_Result> Private_GetOriginalTableInfo(Nullable<int> tableObjectId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Private_GetOriginalTableInfo_Result>("[AdventureWorks2022Entities].[Private_GetOriginalTableInfo](@TableObjectId)", tableObjectIdParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "Private_ResolveFakeTableNamesForBackwardCompatibility")]
        public virtual IQueryable<Private_ResolveFakeTableNamesForBackwardCompatibility_Result> Private_ResolveFakeTableNamesForBackwardCompatibility(string tableName, string schemaName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Private_ResolveFakeTableNamesForBackwardCompatibility_Result>("[AdventureWorks2022Entities].[Private_ResolveFakeTableNamesForBackwardCompatibility](@TableName, @SchemaName)", tableNameParameter, schemaNameParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "Private_ResolveName")]
        public virtual IQueryable<Private_ResolveName_Result> Private_ResolveName(string name)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Private_ResolveName_Result>("[AdventureWorks2022Entities].[Private_ResolveName](@Name)", nameParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "Private_ResolveObjectName")]
        public virtual IQueryable<Private_ResolveObjectName_Result> Private_ResolveObjectName(string name)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Private_ResolveObjectName_Result>("[AdventureWorks2022Entities].[Private_ResolveObjectName](@Name)", nameParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "Private_ResolveSchemaName")]
        public virtual IQueryable<Private_ResolveSchemaName_Result> Private_ResolveSchemaName(string name)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Private_ResolveSchemaName_Result>("[AdventureWorks2022Entities].[Private_ResolveSchemaName](@Name)", nameParameter);
        }
    
        [DbFunction("AdventureWorks2022Entities", "TestCaseSummary")]
        public virtual IQueryable<TestCaseSummary_Result> TestCaseSummary()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<TestCaseSummary_Result>("[AdventureWorks2022Entities].[TestCaseSummary]()");
        }
